...
const LoginMenu = (props: IPatate) => {
  const handleGoogleAuthClick = () => {
    window.location.href = `http://localhost:${PORT}/auth/google`;
  };

  return (
    <div className='text-white flex flex-col rounded-xl justify-start gap-4 bg-gray-800 p-4 mr-4 w-80 h-96 border-gray-400 border-2'>
      <button
