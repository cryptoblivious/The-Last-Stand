...
cd nom_application
yarn
yarn add react-router-dom tailwindcss postcss autoprefixer eslint localforage match-sorter sort-by 
yarn add --dev @types/react-router-dom @types/react @types/postcss @types/autoprefixer @types/eslint @types/localforage @types/match-sorter @types/sort-by
touch .eslintrc.js
