...
const SocialOverlay = () => {
  ...
  return (
    <>
      ...
      <div className={`${overlaying ? 'translate-x-0' : 'translate-x-full'} flex right-0 transition-all duration-1000 fixed top-0 bottom-0 w-fit max-w-5xl z-40 justify-end`}>
        <ChatMenu />
