...
const SocialOverlay = () => {
  ...
  return (
    <div className={`${overlaying ? '-right-5' : '-right-96'} transition-all duration-1000 z-40 bg-black overflow-y-scroll text-pink-600 border-pink-600 border-2 p-3 pr-12 rounded-3xl border-r-0 rounded-r-none w-1/4 flex flex-col fixed top-0 bottom-0 gap-5 `}>
