...
const heroes: Hero[] = [
  { id: 1, name: 'Solana', foldername: 'solana', image: './src/client/assets/heroes/solana/portrait.webp' },
  { id: 2, name: 'Logan', foldername: 'logan', image: './src/client/assets/heroes/logan/portrait.png' },
  { id: 3, name: 'chuck doug', foldername: 'chuck', image: './src/client/assets/heroes/chuck/portrait.png' },
  { id: 4, name: 'Alphonse', foldername: 'alphonse', image: 'https://picsum.photos/450/200' },
  { id: 5, name: 'Bart', foldername: 'bart', image: 'https://picsum.photos/300/200' },
];
